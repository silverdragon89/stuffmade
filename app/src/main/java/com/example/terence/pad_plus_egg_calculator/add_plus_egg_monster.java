...
public class add_plus_egg_monster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //declaring the two Listviews
        mainListView = (ListView) findViewById(R.id.listView1);
        bankListView = (ListView) findViewById(R.id.listView2);
        ...
        ListUtils.setDynamicHeight(bankListView);
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_add_plus_egg_monster, menu);
        return true;
    }
    ...
    //copy pasta from the Hiren Patel code
